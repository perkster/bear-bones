<!-- tpl-main-wrapper-single --><div id="blk-content" class="block--content">
	...
	?>
			<div class="main-content-wrapper main-content-wrapper--<?php echo get_post_type( ); ?>"><div id="main" tabindex="0"></div>
			<main role="main" class="main-content main-content--<?php echo get_post_type( ); ?>">	
