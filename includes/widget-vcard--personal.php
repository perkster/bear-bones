...
class Personal_Vcard_Widget extends WP_Widget {
  function Personal_Vcard_Widget() {
    $widget_ops = array('classname' => 'widget_personal_vcard', 'description' => __('Use this widget to add a personal vCard', 'bear-bones'));
    //$this->WP_Widget('widget_personal_vcard', __('vCard: Personal', 'bear-bones'), $widget_ops);
	parent::__construct( 'widget_personal_vcard', __( 'vCard: Personal', 'bear-bones' ), $widget_ops );
  ...
  function widget($args, $instance) {
    ...
    //$title = apply_filters('widget_title', empty($instance['title']) ? __('vCard', 'bear-bones') : $instance['title'], $instance, $this->id_base);
	//is address set?
	$show_address = true;
  ...
  ?>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('first_name')); ?>"><?php _e('First Name :', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('last_name')); ?>"><?php _e('Last Name :', 'bear-bones'); ?></label>
	...
	<p>
	  ...
	  <label for="<?php echo $this->get_field_id('show_name'); ?>"><?php _e('Show Name', 'bear-bones'); ?></label>
    </p>
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'bear-bones'); ?></label>
      <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
	<hr>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('street_address')); ?>"><?php _e('Street Address:', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('extended_address')); ?>"><?php _e('Extended Address: ', 'bear-bones'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('locality')); ?>"><?php _e('City/Locality:', 'bear-bones'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('region')); ?>"><?php _e('State/Region:', 'bear-bones'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('postal_code')); ?>"><?php _e('Zipcode/Postal Code:', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php _e('Country: ', 'bear-bones'); ?></label>
	...
	<hr>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('tel')); ?>"><?php _e('Telephone:', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('tel_label')); ?>"><?php _e('Label for Telephone (ex. "Tel:"):', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php _e('Fax: ', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('fax_label')); ?>"><?php _e('Fax Label: ', 'bear-bones'); ?></label>
    ...
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php _e('Email: ', 'bear-bones'); ?></label>
      <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>" />
    </p>
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('email_label')); ?>"><?php _e('Email label: ', 'bear-bones'); ?></label>
