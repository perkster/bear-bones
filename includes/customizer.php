...
function bear_bones_customize_register($wp_customize) {
	...
	$wp_customize->add_section( 'bear_bones_style_options', array(
			'title'          => __( 'Style Options', 'bear-bones' ),
			'priority'       => 30,
		) );
	...
	$wp_customize->add_control(	new Bear_Bones_Customizer_Control(
			$wp_customize,
			'bb_extra_css',
			array(
				'label' => 'Included extra css',
	...
	$wp_customize->add_section( 'bear_bones_js_options', array(
		'title'          => __( 'JS Options', 'bear-bones' ),
		'priority'       => 35,
	) );
	...
	$wp_customize->add_control(	new Bear_Bones_Customize_Textarea_Control(
			$wp_customize,
			'bb_google_tag_manager',
			array(
				'label' => 'Google Tag Manager code',
				'section' => 'bear_bones_js_options',
				'settings' => 'google_tag_manager',
				'extra' =>'To retrieve your tag manager code, go to https://tagmanager.google.com',
				'priority'       => 15,				
			)
		)
	);	
    ...
    $wp_customize->add_section( 'bear_bones_logo_settings', array(
        'title'          => __( 'Logo options', 'bear-bones' ),
        'priority'       => 40,
    ) );
	...
	$wp_customize->add_setting( 'logo_svg', array(
		...
		$wp_customize->add_control(	'logo_svg',
			array(
				'type' => 'checkbox',
				'label' => 'Is logo a svg?',
				'section' => 'bear_bones_logo_settings',
	...
	*/
	$wp_customize->add_setting( 'logo_method', array(
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_key',		
    ) );	
	$wp_customize->add_control( 'logo_method', array(
		'label'      => 'Method to insert logo',
		'section'    => 'bear_bones_logo_settings',
		'type'       => 'select',
		//widget placement: 1= above, 2=left, 3 = right, 4 = below
		'choices' => array(
	...
	$wp_customize->add_setting( 'logo_fallback', array(
        'default'        => null,
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ...
    $wp_customize->add_control( 'logo_fallback', array(
        'label'   => 'Fallback for logo',
        'section' => 'bear_bones_logo_settings',
        'type'    => 'text',
		'priority'       => 10,
    ) );
	...
	$wp_customize->add_section( 'bear_bones_header_settings', array(
        'title'          => __( 'Header & Main Menu', 'bear-bones' ),
        'priority'       => 50,
    ) );
	...
	$wp_customize->add_section( 'bear_bones_addl_settings', array(
        'title'          => __( 'Additional Settings', 'bear-bones' ),
        'priority'       => 100,
    ) );
	...
	$wp_customize->add_setting( 'pages_yoast_breadcrumbs', array(
		'default'		=> 0,
		'type'			=> 'theme_mod',
		'capability' 	=> 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_checkbox',
	) );
	$wp_customize->add_control(	'pages_yoast_breadcrumbs',
		array(
			'type' => 'checkbox',
			'label' => 'Use Yoast breadcrumb on pages',
			'section' => 'bear_bones_pages_options',
			'priority'       => 20,
		)
	);
	...
	$wp_customize->add_setting( 'pages__featured_class', array(
        'default'        => 'page-featured-image__image',
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ) );
	...
	$wp_customize->add_setting( 'page__featured_image', 
		array(
			'default'        => null,
			'type'			 => 'theme_mod',
			'capability'     => 'edit_theme_options',
	...
	$wp_customize->add_control( new Bear_Bones_Custom_Text_Control( 
		$wp_customize, 
		'page__featured_image', 
		array(
			'label' => 'Pages featured image size (page-featured)',
			'section' => 'bear_bones_pages_options',
			'settings' => 'page__featured_image',
			'extra' => 'width-height-crop(optional)',
			'priority'	=> 80,
        ) ) 
    );
	$wp_customize->add_setting( 'page__thumbnail', 
		array(
			'default'        => null,
			'type'			 => 'theme_mod',
			'capability'     => 'edit_theme_options',
	...
	$wp_customize->add_control( new Bear_Bones_Custom_Text_Control( 
		...
		'page__thumbnail', 
		array(
			'label' => 'Pages thumbnail image size (page-thumbnail)',
			'section' => 'bear_bones_pages_options',
			'settings' => 'page__thumbnail',
			'extra' => 'width-height-crop(optional)',
			'priority'	=> 90,
        ) ) 
    );
	
	$wp_customize->add_setting( 'pages__default_featured_image', array(
        'default'        => null,
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ...
    $wp_customize->add_control( 'pages__default_featured_image', array(
        'label'   => 'Default page featured image',
        'section' => 'bear_bones_pages_options',
        'type'    => 'text',
		'priority'       => 100,
    ) );
	$wp_customize->add_setting( 'pages__default_featured_image_caption', array(
        'default'        => null,
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ...
    $wp_customize->add_control( 'pages__default_featured_image_caption', array(
        'label'   => 'Default page featured image caption',
        'section' => 'bear_bones_pages_options',
        'type'    => 'text',
		'priority'       => 110,
    ) );
	...
	$wp_customize->add_setting( 'posts__excerpt_read_more', array(
        'default'        => '...',
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ...
    $wp_customize->add_control( 'posts__excerpt_read_more', array(
        'label'   => 'Appended to a lengthy excerpt',
        'section' => 'bear_bones_posts',
        'type'    => 'text',
		'priority'       => 20,
    ) );	
	...
	$wp_customize->add_setting( 'posts__link_title', array(
    ...
    $wp_customize->add_control( 'posts__link_title', array(
        'label'   => 'Link title attribute',
        'section' => 'bear_bones_posts',
        'type'    => 'text',
		'priority'       => 25,
    ) );
	$wp_customize->add_setting( 'posts__read_more_div', array(
        'default'        => 'Read More',
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_text',
    ...
    $wp_customize->add_control( 'posts__read_more_div', array(
	...
	$wp_customize->add_section( 'bear_bones_post_links', array(
        'title'          => __( 'Post Links', 'bear-bones' ),
		'priority'		 => 150,
    ) );
	...
	$wp_customize->add_section( 'bear_bones_login_settings', array(
        'title'          => __( 'Login', 'bear-bones' ),
		'priority'		 => 200,
    ) );
	
	
	$wp_customize->add_setting( 'login_bgc_color', array(
        'default'        => '#F2F7FA',
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_css_color',
    ...
    $wp_customize->add_control( 'login_bgc_color', array(
        'label'   => 'Background color for login screen',
        'section' => 'bear_bones_login_settings',
        'type'    => 'text',
		'priority'       => 50,
    ) );
    ...
    $wp_customize->add_control( 'login_link_color', array(
        'label'   => 'Color for nav links on login screen',
        'section' => 'bear_bones_login_settings',
        'type'    => 'text',
		'priority'       => 55,
    ) );
	$wp_customize->add_setting( 'login_link_hover_color', array(
        'default'        => '#4D4D4D',
		'type'			 => 'theme_mod',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'bb_sanitize_css_color',
    ...
    $wp_customize->add_control( 'login_link_hover_color', array(
        'label'   => 'Color for nav links hover on login screen',
        'section' => 'bear_bones_login_settings',
        'type'    => 'text',
		'priority'       => 60,
    ) );
	...
	$wp_customize->add_section( 'bear_bones_woocommerce_settings', array(
        'title'          => __( 'WooCommerce', 'bear-bones' ),
		'priority'		 => 400,
    ) );
...
if (class_exists('WP_Customize_Control')) {
	...
	class Bear_Bones_Customizer_Control extends WP_Customize_Control {
		//public $type = '';
		public $extra = '';
	 
		public function render_content() {
			switch ($this->type) {
				//debug_to_console($this->type);
				case 'textarea':				
			?>
					<label>
			...
			<?php
				...
				case 'heading':
					...
					if( isset ( $this->extra ) ) '<span><?php echo esc_html( $this->extra ); ?></span>';
					echo '</label>';
					break;
...
$wp_customize->add_control( new Bear_Bones_Custom_Text_Control( 
	...
	*/
	 ...
	 */
	class Bear_Bones_Customize_Control_Multiple_Select extends WP_Customize_Control {
...
function bb_sanitize_css_color ( $input ) {
	//prar($input);
	if( substr( $input, 0, 1 ) == "#") {
		$color =  substr ( $input, 1) ;
	} else {
		$color = $input ;
	}
	if( strlen( $color ) != 6 || strlen( $color ) != 3 ) $color = 0;
	///#([a-fA-F0-9]){3}(([a-fA-F0-9]){3})?\b/
	preg_match_all('/#([a-f]|[A-F]|[0-9]){3}(([a-f]|[A-F]|[0-9]){3})?\b/', $input, $matches);
	//prar($matches);
