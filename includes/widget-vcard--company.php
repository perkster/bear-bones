...
// Example vCard widget - taken from bear_bones theme
class Company_Vcard_Widget extends WP_Widget {
  function Company_Vcard_Widget() {
    $widget_ops = array('classname' => 'widget_company_vcard', 'description' => __('Use this widget to add a company vCard', 'bear-bones'));
	
	parent::__construct( 'widget_company_vcard', __( 'vCard: Company', 'bear-bones' ), $widget_ops );
  ...
  ?>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title (optional):', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('extended_address')); ?>"><?php _e('Extended Address: (Optional)', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php _e('Country: (optional)', 'bear-bones'); ?></label>
	...
	<p>
      <label for="<?php echo esc_attr($this->get_field_id('extra_html')); ?>"><?php _e('Extra html: ', 'bear-bones'); ?></label>
