...
<body <?php body_class(); ?>>
<?php
	$bb_google_tag_manager = get_theme_mod('google_tag_manager');
	if( $bb_google_tag_manager ) echo '<script>' . $bb_google_tag_manager . '</script>';
?>
<!--[if lt IE 7]>
...
?>				
	...
	<div class="back-to-top-wrapper"><a href="#main" class="back-to-top" title="Back to Top"><i></i><span>Back To Top</span></a></div>